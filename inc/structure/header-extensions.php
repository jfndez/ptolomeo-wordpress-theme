	...
	if ( ( 1 != $set_flags ) || ( 1 == $set_flags ) )  {
				...
				foreach( $social_links as $key => $value ) {
					if ( !empty( $options[ $value ] ) ) {
						$a .=
							'<li class="'.strtolower($key).'" style="align: left" ><a href="'.esc_url( $options[ $value ] ).'" title="'.sprintf( esc_attr__( '%1$s en %2$s', 'interface' ), get_bloginfo( 'name' ), $social_links_name[$i] ).'" target="_blank">'.'</a></li>';
					}
				$i++;	
				}
...
<div class="hgroup-wrap">
  <div class="container clearfix">
    <section id="site-logo" class="clearfix">
      ...
      <h1 id="site-title"> <a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?>
        </a> </h1>
      ...
      <h2 id="site-description">
        ...
        <?php } ?>
      </h2> <?php interface_socialnetworks( $set_flags );?><br><br>
      <?php
						}
...
<div class="page-title-wrap">
  <div class="container clearfix">
    ...
    <h1 class="page-title"><?php if (!is_tax('responsable')): ?><?php echo interface_header_title(); ?><?php endif; ?><?php if (is_tax('responsable')): ?><font color="#000000">---</font><?php endif; ?></h1>
    <?php	}?>
    <!-- .page-title --> 
  </div>
</div>
...
function interface_header_title() {
	...
	elseif( is_404() ) {
		$interface_header_title = __( 'Página no encontrada.', 'interface' );
	}
	elseif( is_search() ) {
		$interface_header_title = __( 'Resultado de la búsqueda', 'interface' );
	}
